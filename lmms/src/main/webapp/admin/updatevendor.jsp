...
<body>
	...
	<div class="card-box">
		<div class="header">
			<h3>
				<i class="fas fa-edit me-2"></i>Update Vendor
			</h3>
			<p class="mb-0 opacity-75">Modify vendor details</p>
		</div>

		<form action="./updateVendorController.jsp" method="post">
			<!-- Vendor ID (Read Only) -->
			...
			<div class="d-flex gap-2">
				<a href="./updateVendorController.jsp"><button type="submit"
